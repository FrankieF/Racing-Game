...
void UGoKartMovementReplicator::ClientTick(float DeltaTime)
{
	...
	if (ClientTimeBetweenLastUpdates < KINDA_SMALL_NUMBER || MovementComponent == nullptr) return;
...
bool UGoKartMovementReplicator::Server_SendMove_Validate(FGoKartMove Move)
{
	...
	bool ClientisRunningAhead = GetWorld()->TimeSeconds > ProposedTime;
	if (ClientisRunningAhead)
	{
	...
	if (!Move.IsValid())
	{
		UE_LOG(LogTemp, Error, TEXT("Received an invalid move."))
		return false;
	}
	return true;
}